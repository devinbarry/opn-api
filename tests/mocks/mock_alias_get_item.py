def mock_get_item_data(uuid):
    return {'alias': {
        ...
        'proto': {'IPv4': {'value': 'IPv4', 'selected': 0},
        ...
        'counters': '0',
        'updatefreq': '',
        'content': {'10.178.23.119': {'value': '10.178.23.119', 'selected': 1},
                    ...
                    'monitoring_tool': {'selected': 0,
                                    'value': 'monitoring_tool',
                                    'description': 'Monitoring Tool VM'},
                    'Secure_VM': {'selected': 0,
                                  'value': 'Secure_VM',
                    ...
                    'virusprot': {'selected': 0,
                                  'value': 'virusprot',
                                  'description': 'overload table for rate limiting (internal)'},
                    'sshlockout': {'selected': 0,
                                   'value': 'sshlockout',
                                   'description': 'abuse lockout table (internal)'},
                    '__wan_network': {'selected': 0,
                                      'value': '__wan_network',
                                      'description': 'WAN net'},
                    '__lan_network': {'selected': 0,
                                      'value': '__lan_network',
                                      'description': 'LAN net'},
                    '__lo0_network': {'selected': 0,
                                      'value': '__lo0_network',
                                      'description': 'Loopback net'},
                    '__opt1_network': {'selected': 0,
                                       'value': '__opt1_network',
                                       'description': 'SubnetE net'},
                    '__opt2_network': {'selected': 0,
                                       'value': '__opt2_network',
                                       'description': 'Switch2 net'},
                    '__opt3_network': {'selected': 0,
                                       'value': '__opt3_network',
                                       'description': 'Unifi net'},
                    '__opt4_network': {'selected': 0,
                                       'value': '__opt4_network',
                                       'description': 'IOT net'},
                    '__opt5_network': {'selected': 0,
                                       'value': '__opt5_network',
                                       'description': 'Switch3 net'},
                    '__opt6_network': {'selected': 0,
                                       'value': '__opt6_network',
                                       'description': 'UPS net'}},
        'categories': {'f04a0dac-798e-48b8-8ff5-3380a25c2e8c': {'value': 'Uptime Kuma',
                                                                'selected': 0}},
        'description': 'HostA MBP on various subnets'}}
