...
from opn_api.formats.cols_output import ColsOutputFormat
...
class TestColsOutputFormat(FormatTestCase):
    ...
    def test_output_all_columns_with_json_obj(self):
        ...
        self.assertIn("enabled,name,type,proto,counters,updatefreq,content,description,uuid\n", result)
    ...
    def test_output_all_columns_with_json_nested(self):
        ...
        self.assertIn("<ID>,name,supportedOptions\n", result)
